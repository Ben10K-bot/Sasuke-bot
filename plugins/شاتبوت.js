...
if (/^احمد كانكي$/i.test(m.text) ) { //sem prefixo 
 ...
 conn.reply(m.chat, `ملك اللعنات❤️‍🔥🐦`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
    ...
    if (/^كسمك|متناك|معرص|خول|كس امك|معرس|قحبه|ابن الوسخه|منيوك|ابن الكلب|ابن المتناكه|طيز|شرموط|شرموطه$/i.test(m.text) ) { //sem prefixo 
 ...
 conn.reply(m.chat, `وعليكم السلام و رحمه الله و بركاته 😍❤`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
    ...
    if (/^البوت|بوت$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `اسمي ساسكي يسطا🐦💔`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
